package
{
	...
	[SWF(width="320",height="480",frameRate="60",backgroundColor="#01579B")]
	public class FarmsApp extends Sprite
	{
		public static var conn:SQLConnection;
		private var myStarling:Starling;
		private var myScaler:ScreenDensityScaleFactorManager;
				
		public function FarmsApp()
		{			
			if(this.stage)
			{
			...
			var db:File = File.applicationDirectory.resolvePath("assets/farms.sqlite");
